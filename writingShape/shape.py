...
for cnt in contours:
	...
	if area > 1000:
		...
		cv2.drawContours(img, [approx], 0, (0), thickness=2, lineType=None, hierarchy=None, maxLevel=None, offset=None)
		x = approx.ravel()[0]
		y = approx.ravel()[1]
		if len(approx) == 3:
...
colors(img, (20,127,127), (40,255,255), "Yellow", (111,220,247))
